...
fun AppAPKFragment.initTabsWithViewPager() {

    val listType = mutableListOf<String>()

    listType.add("All app")
    listType.add("All apk")

    val tabs: TabLayout = binding.tbAppAPK
    val viewPager: ViewPager2 = binding.vpAppAPK

package volio.tech.sharefile.framework.presentation.send.image.adapter.paging
...
import volio.tech.sharefile.framework.presentation.send.image.adapter.FolderDiffUtilCallback
...
class PagingImageParentAdapter(
    val dataLocal: DataLocal,
    val lifecycleCoroutineScope: LifecycleCoroutineScope
) : PagingDataAdapter<Folder, RecyclerView.ViewHolder>(FolderDiffUtilCallback()) {
